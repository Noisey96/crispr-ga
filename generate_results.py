...
if __name__ == '__main__':
    ...
    #generate_results(setup_tsp, held_karp, list(range(10, 20, 10)), "tsp/medium.csv", "results.txt"))
    #generate_results(setup_tsp, tsp_generational_ga, list(range(10, 110, 10)), "tsp/medium.csv", "results_ga.txt")
    generate_results(setup_tsp, tsp_generational_ga, [5, 10, 15, 20, 23], "tsp/medium.csv", "results_ga.txt")
